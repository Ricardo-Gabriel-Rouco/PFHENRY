...
const Carrousel = () => {
  ...
  return (
    <>
      ...
      {/*         CARROUSEL OFERTAS */}
      <Typography align="left" fontWeight={'bold'} variant="h6" marginTop={"1rem"} marginLeft={'1rem'}>
        {"SALES"}
      </Typography>
            ...
            book.display && book.discount ? (
              <SwiperSlide key={book.id} >
                <Grid
                  ...
                  lg={true}
                >
                  <Paper elevation={5} style={{ margin: '1rem', display: 'flex', justifyContent: 'center', borderRadius: '10px', minWidth: '15rem', backgroundColor: 'inherit' }}>
