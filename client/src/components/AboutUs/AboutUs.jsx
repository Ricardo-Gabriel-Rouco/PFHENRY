            ...
            <section id="about" className={s.container}>
                ...
                <div className={s.cardsContainer}>
                    ...
                    <div className={s.card}>
                        ...
                        <a href="https://github.com/mmitacc"> <AiFillGithub className={s.gitHub} icon={AiFillGithub} /> </a>
                    ...
                    <div className={s.card}>
                        ...
                        <a href="https://github.com/diegohp141"> <AiFillGithub className={s.gitHub} icon={AiFillGithub} /> </a>
                    ...
                    <div className={s.card}>
                        ...
                        <a href="https://github.com/mlsalerno"> <AiFillGithub className={s.gitHub} icon={AiFillGithub} /> </a>

                        <a href="https://www.linkedin.com/in/mauricio-salerno-b06640221/"> <AiFillLinkedin className={s.linkedin} icon={AiFillLinkedin} /> </a>
                    ...
                    <div className={s.card}>
                        ...
                        <a href="https://github.com/claperalta"> <AiFillGithub className={s.gitHub} icon={AiFillGithub} /> </a>
