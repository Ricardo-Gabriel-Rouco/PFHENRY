  ...
  try {
    ...
    const preference = {
      ...
      back_urls: {
        ...
        success: `https://pfhenry-dac4-git-main-ricardo-gabriel-rouco.vercel.app/payStatus?idUser=${user.name}`,
        pending: '',
        failure: `https://pfhenry-dac4-git-main-ricardo-gabriel-rouco.vercel.app/payStatus?idUser=${user.name}`
